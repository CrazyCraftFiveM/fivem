...
Citizen.CreateThread(function()
    ...
    local cayomap = AddBlipForCoord(4981.02, -5698.86, 19.88)

    SetBlipSprite(cayomap, 429)
    SetBlipColour(cayomap, 1)
    SetBlipScale(cayomap, 0.80)
    SetBlipAsShortRange(cayomap, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("Maison")
    EndTextCommandSetBlipName(cayomap)
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(Config.pos) do
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'cayo' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cayo' then 
...
RMenu.Add('garagecayo', 'main', RageUI.CreateMenu("Garage", "Garage Cayo"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('garagecayo', 'main'), true, true, true, function() 
    ...
    RageUI.ButtonWithStyle("Baller", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
        ...
        Citizen.Wait(1)  
        spawnuniCar("baller6")
        SetVehicleCustomPrimaryColour(vehicle, 124, 0, 0) 
        end
    end)
    ...
    RageUI.ButtonWithStyle("Nissan 4x4", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
        if (Selected) then
        Citizen.Wait(1)  
        spawnuniCar("nissantitan17")
        SetVehicleCustomPrimaryColour(vehicle, 125, 0, 0)
        end
    end)
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'cayo' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cayo' then    
                    ...
                    if IsControlJustPressed(1,51) then           
                        RageUI.Visible(RMenu:Get('garagecayo', 'main'), not RageUI.Visible(RMenu:Get('garagecayo', 'main')))
                    end   
                end
               end 
        end
...
function spawnuniCar(car)
    ...
    local plaque = "cayo"..math.random(1,9)
    SetVehicleNumberPlateText(vehicle, plaque) 
    SetPedIntoVehicle(GetPlayerPed(-1),vehicle,-1)
    SetVehicleCustomPrimaryColour(vehicle, 125, 0, 0)
    SetVehicleCustomSecondaryColour(vehicle, 125, 0, 0)
...
RMenu.Add('armucayo', 'main', RageUI.CreateMenu("Armurerie", " "))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('armucayo', 'main'), true, true, true, function()   
            ...
            RageUI.ButtonWithStyle(v.nom, nil, {RightLabel = "~r~$"..v.prix},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('armurerie:cayo', v.arme, v.prix)
                end
            end)
        end
...
Citizen.CreateThread(function()
        while true do
		   ...
		   if ESX.PlayerData.job and ESX.PlayerData.job.name == 'cayo' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cayo' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('armucayo', 'main'), not RageUI.Visible(RMenu:Get('armucayo', 'main')))
                    end   
                end
            end 
        end
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'cayo' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cayo' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('coffrecayo', 'main'), not RageUI.Visible(RMenu:Get('coffrecayo', 'main')))
                    end   
                end
               end 
        end
...
function OpenGetStockscayoMenu()
    ESX.TriggerServerCallback('esx_cayojob:prendreitem', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_cayojob:prendreitems', itemName, count)
...
function OpenPutStockscayoMenu()
    ESX.TriggerServerCallback('esx_cayojob:inventairejoueur', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_cayojob:stockitem', itemName, count)
...
function OpenGetWeaponMenu()
	...
	ESX.TriggerServerCallback('esx_cayojob:getArmoryWeapons', function(weapons)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon',
		{
			...
			ESX.TriggerServerCallback('esx_cayojob:removeArmoryWeapon', function()
				OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon',
	{
		...
		ESX.TriggerServerCallback('esx_cayojob:addArmoryWeapon', function()
			OpenPutWeaponMenu()
...
RMenu.Add('cayof6', 'main', RageUI.CreateMenu("Cayo", "Intéraction"))
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('cayof6', 'main'), true, true, true, function()
        ...
        RageUI.ButtonWithStyle("Menotter/démenotter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
            if (Selected) then
                ...
                local target_id = GetPlayerServerId(target)
                if closestPlayer ~= -1 and closestDistance <= 3.0 then 
                TriggerServerEvent('esx_cayojob:handcuff', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
            ...
            RageUI.ButtonWithStyle("Escorter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_cayojob:drag', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
            ...
            RageUI.ButtonWithStyle("Mettre dans un véhicule", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_cayojob:putInVehicle', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
                end
            ...
            RageUI.ButtonWithStyle("Sortir du véhicule", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_cayojob:OutVehicle', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'cayo' then  

                    if IsControlJustPressed(0, 167) then
                        RageUI.Visible(RMenu:Get('cayof6', 'main'), not RageUI.Visible(RMenu:Get('cayof6', 'main')))
                end   
        end 
    end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            ...
            if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cayo' then 
...
RegisterNetEvent('esx_cayojob:handcuff')
AddEventHandler('esx_cayojob:handcuff', function()
...
RegisterNetEvent('esx_cayojob:drag')
AddEventHandler('esx_cayojob:drag', function(cop)
...
RegisterNetEvent('esx_cayojob:putInVehicle')
AddEventHandler('esx_cayojob:putInVehicle', function()
...
RegisterNetEvent('esx_cayojob:OutVehicle')
AddEventHandler('esx_cayojob:OutVehicle', function(t)
...
function OpenBodySearchMenu(player)
	ESX.TriggerServerCallback('esx_cayojob:getOtherPlayerData', function(data)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value then
				TriggerServerEvent('esx_cayojob:confiscatePlayerItem', GetPlayerServerId(player), data.current.itemType, data.current.value, data.current.amount)
